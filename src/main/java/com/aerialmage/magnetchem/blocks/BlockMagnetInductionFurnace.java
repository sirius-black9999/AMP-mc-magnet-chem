...
public class BlockMagnetInductionFurnace extends BlockMagnetic {

	public BlockMagnetInductionFurnace(Material par2Material) {
		super(par2Material);
    ...
    public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
    {
        ...
        {
        	TileEntityMagneticInductionFurnace tileentityfurnace = (TileEntityMagneticInductionFurnace)par1World.getTileEntity(par2, par3, par4);
    ...
    {
        return magnetchem.blockMagneticInductionFurnace;
    }
    
	@Override
	public TileEntity createTileEntity(World world, int metadata) {
		return new TileEntityMagneticInductionFurnace();
	}
